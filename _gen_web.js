...
const html = '<!DOCTYPE html><html lang="zh-CN"><head><meta charset="utf-8">' +
  ...
  '.ex-img-wrap{aspect-ratio:1/1;background:#f3f4f6;display:flex;align-items:center;justify-content:center}' +
  '.ex-img{max-width:100%;max-height:100%;object-fit:contain;display:block}' +
  '.ex-noimg{aspect-ratio:1/1;display:flex;align-items:center;justify-content:center;background:#f3f4f6;color:#9ca3af;font-size:13px}' +
