// 增强版动作数据库 — 数据来源: hasaneyldrm/exercises-dataset
// 自动生成时间: 2025-07-08
// 包含中英文教学指令、目标肌群、180x180 GIF动画
// v2: 添加 instruction_steps 分步中文指令
...
window.EXERCISE_DB = [
{
  ...
  "equipment": "dumbbell",
  "gif": "exercise_gifs/0292-C0MA9bC.gif",
  "gif_url": "videos/0292-C0MA9bC.gif",
  "instructions_cn": "",
  "instructions_en": {
    "en": "Stand with your feet shoulder-width apart, holding a dumbbell in one hand with your palm facing your body. Bend your knees slightly and hinge forward at the hips, keeping your back straight and your core engaged. Let the dumbbell hang straight down towards the floor, with your arm fully extended. Pull the dumbbell up towards your chest, keeping your elbow close to your body and squeezing your shoulder blades together. Pause for a moment at the top, then slowly lower the dumbbell back down to the starting position. Repeat for the desired number of repetitions, then switch sides.",
    "it": "Stai in piedi con i piedi a larghezza delle spalle, tenendo un manubrio in una mano con il palmo rivolto verso il corpo. Flette leggermente le ginocchia e incurva in avanti sui fianchi, mantenendo la schiena dritta e il core attivo. Lascia che il manubrio penda dritto verso il pavimento, con il braccio completamente esteso. Tira il manubrio verso il petto, tenendo il gomito vicino al corpo e stringendo le scapole insieme. Fermati un attimo in cima, poi abbassa lentamente il manubrio fino alla posizione di partenza. Ripeti per il numero desiderato di ripetizioni, poi cambia lato.",
    ...
    "zh": "双脚分开与肩同宽站立，一手握住哑铃，手掌朝向身体。 稍微弯曲膝盖，髋部向前转动，保持背部挺直，核心肌群参与。 让哑铃垂直垂向地板，手臂完全伸展。 将哑铃向上拉向胸部，保持肘部靠近身体并将肩胛骨挤压在一起。 在顶部停顿片刻，然后慢慢将哑铃放回起始位置。 重复所需的重复次数，然后换边。"
  },
  "instruction_steps": {
    "en": [
...
},
{
  ...
  "equipment": "dumbbell",
  "gif": "exercise_gifs/0293-BJ0Hz5L.gif",
  "gif_url": "videos/0293-BJ0Hz5L.gif",
  "instructions_cn": "",
  "instructions_en": {
    ...
    "it": "Stai con i piedi a larghezza delle spalle, le ginocchia leggermente piegate, e tieni un manubrio in ciascuna mano con i palmi rivolti verso il corpo. Piegati in avanti sui fianchi, mantenendo la schiena dritta e il core attivo. Lascia che le braccia pendano dritte verso il pavimento, con i gomiti leggermente piegati. Tira i manubri verso il petto, stringendo le scapole insieme. Fermati un attimo in cima, poi abbassa lentamente i manubri fino alla posizione iniziale. Ripeti per il numero desiderato di ripetizioni.",
    ...
    "zh": "双脚分开与肩同宽站立，膝盖稍微弯曲，双手各握一个哑铃，手掌朝向身体。 臀部向前弯曲，保持背部挺直，核心肌群参与。 让你的手臂垂直垂向地板，肘部稍微弯曲。 将哑铃拉向胸部，将肩胛骨挤压在一起。 在顶部停顿片刻，然后慢慢将哑铃放回起始位置。 重复所需的重复次数。"
  },
  "instruction_steps": {
    "en": [
...
},
{
  ...
  "instructions_cn": "",
  "instructions_en": {
    "en": "Stand with your feet shoulder-width apart and hold a dumbbell in each hand, palms facing your body. Bend your knees slightly and hinge forward at the hips, keeping your back straight. Raise your arms out to the sides, keeping a slight bend in your elbows, until they are parallel to the floor. Pause for a moment at the top, then slowly lower your arms back down to the starting position. Repeat for the desired number of repetitions.",
    "it": "Stai in piedi con i piedi alla larghezza delle spalle e tieni un manubrio in ogni mano, palmi rivolti verso il corpo. Piega leggermente le ginocchia e piega in avanti ai fianchi, mantenendo la schiena dritta. Alza le braccia ai lati, mantenendo una leggera piega dei gomiti, finché non sono paralleli al pavimento. Fermati un attimo in cima, poi abbassa lentamente le braccia fino alla posizione iniziale. Ripeti per il numero desiderato di ripetizioni.",
...
},
{
  ...
  "instructions_en": {
    ...
    "zh": "站直，双手各握一个哑铃，手掌朝前，双臂完全伸展。 保持上臂静止，呼气并弯举哑铃，同时收缩二头肌。 继续举起哑铃，直到二头肌完全收缩并且哑铃与肩部齐平。 挤压二头肌时，保持收缩位置短暂停顿。 吸气并慢慢开始将哑铃放回起始位置。 重复所需的重复次数，交替手臂。"
  },
  "instruction_steps": {
    "en": [
...
},
{
  ...
  "instructions_en": {
    ...
    "zh": "站直，双手各持一个哑铃，手掌朝向躯干。 保持肘部靠近躯干，并旋转手掌，直到手掌朝前。 这将是您的起始位置。 现在，保持上臂静止，呼气并卷曲哑铃，同时收缩二头肌。 继续举重，直到二头肌完全收缩并且哑铃与肩部齐平。 挤压二头肌时，保持收缩位置短暂停顿。 然后，吸气并慢慢开始将哑铃放回起始位置。 重复建议的重复次数。"
  },
  "instruction_steps": {
    "en": [
...
},
{
  ...
  "instructions_cn": "",
  "instructions_en": {
    "en": "Lie flat on a bench with your feet flat on the ground and your back pressed against the bench. Hold a dumbbell in each hand, with your palms facing forward and your arms extended above your chest. Lower the dumbbells slowly to the sides of your chest, keeping your elbows at a 90-degree angle. Pause for a moment, then push the dumbbells back up to the starting position, fully extending your arms. Repeat for the desired number of repetitions.",
    "it": "Sdraiati disteso su una panca con i piedi piatti a terra e la schiena premuta contro la panca. Tieni un manubrio in ogni mano, con i palmi rivolti in avanti e le braccia estese sopra il petto. Abbassa lentamente i manubri ai lati del petto, mantenendo i gomiti a 90 gradi. Fermati un attimo, poi spingi i manubri di nuovo alla posizione iniziale, estendendo completamente le braccia. Ripeti per il numero desiderato di ripetizioni.",
    "tr": "Ayaklarınız yere düz basacak ve sırtınız banka yaslanacak şekilde bir bankın üzerine düz bir şekilde uzanın. Avuç içleriniz öne bakacak ve kollarınız göğsünüzün üzerine uzatılacak şekilde her iki elinize de birer dambıl tutun. Dirseklerinizi 90 derecelik bir açıda tutarak dambılları yavaşça göğsünüzün yanlarına doğru indirin. Bir an duraklayın, ardından kollarınızı tamamen uzatarak dambılları başlangıç ​​pozisyonuna doğru itin. İstenilen sayıda tekrar için tekrarlayın.",
    ...
    "zh": "平躺在长凳上，双脚平放在地上，背部紧贴长凳。 双手各握一个哑铃，手掌朝前，双臂伸至胸部上方。 慢慢地将哑铃降低到胸部两侧，保持肘部呈 90 度角。 暂停片刻，然后将哑铃推回起始位置，完全伸展双臂。 重复所需的重复次数。"
  },
  "instruction_steps": {
    "en": [
...
},
{
  ...
  "instructions_en": {
    ...
    "zh": "设置一个 45 度角的上斜凳。 坐在长凳上，双脚平放在地上，背部紧贴长凳。 双手各握一个哑铃，掌心向前，将哑铃举至肩高。 慢慢地将哑铃降低到胸部两侧，保持肘部呈 90 度角。 将哑铃推回起始位置，充分伸展手臂。 重复所需的重复次数。"
  },
  "instruction_steps": {
    "en": [
...
},
{
  ...
  "equipment": "dumbbell",
  "gif": "exercise_gifs/0405-znQUdHY.gif",
  "gif_url": "videos/0405-znQUdHY.gif",
  "instructions_cn": "",
  "instructions_en": {
    ...
    "it": "Siediti su una panchina con un manubrio in ogni mano, appoggiato sulle cosce. Alza i manubri all'altezza delle spalle, palmi rivolti in avanti. Premi i manubri verso l'alto finché le braccia non sono completamente estese sopra la testa. Fermati un attimo in cima, poi abbassa lentamente i manubri all'altezza delle spalle. Ripeti per il numero desiderato di ripetizioni.",
    "tr": "Her iki elinizde birer dambıl olacak şekilde bir bankta oturun ve kalçalarınıza yaslanın. Dambılları omuz hizasına kadar kaldırın, avuç içleriniz öne baksın. Kollarınız başınızın üzerine tamamen uzatılıncaya kadar dambılları yukarıya doğru bastırın. Tepe noktasında bir süre duraklayın, ardından dambılları yavaşça omuz yüksekliğine indirin. İstenilen sayıda tekrar için tekrarlayın.",
    ...
    "zh": "坐在长凳上，每只手各拿一个哑铃，放在大腿上。 将哑铃举至肩高，手掌朝前。 向上推哑铃，直到手臂完全伸过头顶。 在顶部停顿片刻，然后慢慢将哑铃放回肩部高度。 重复所需的重复次数。"
  },
  "instruction_steps": {
    "en": [
...
},
{
  ...
  "equipment": "dumbbell",
  "gif": "exercise_gifs/0334-DsgkuIt.gif",
  "gif_url": "videos/0334-DsgkuIt.gif",
  "instructions_cn": "",
  "instructions_en": {
    ...
    "it": "Stai in piedi con i piedi alla larghezza delle spalle e tieni un manubrio in ogni mano, palmi rivolti verso il corpo. Tieni la schiena dritta e attiva il core. Alza le braccia ai lati finché non sono parallele al pavimento, mantenendo una leggera piega dei gomiti. Fermati un attimo in cima, poi abbassa lentamente le braccia fino alla posizione iniziale. Ripeti per il numero desiderato di ripetizioni.",
    ...
    "zh": "双脚分开与肩同宽站立，双手各握一个哑铃，手掌朝向身体。 保持背部挺直并启动核心肌群。 将手臂向两侧抬起，直到与地板平行，保持肘部稍微弯曲。 在顶部暂停片刻，然后慢慢将手臂放回起始位置。 重复所需的重复次数。"
  },
  "instruction_steps": {
    "en": [
      "Stand with your feet shoulder-width apart and hold a dumbbell in each hand, palms facing your body.",
...
},
{
  ...
  "instructions_en": {
    ...
    "it": "Stai con i piedi a larghezza delle spalle, tenendo un manubrio verticalmente contro il petto con entrambe le mani. Mantenendo il petto sollevato e il core attivo, abbassa il corpo in posizione squat spingendo indietro i fianchi e piegando le ginocchia. Continua ad abbassare finché le cosce non sono parallele al suolo, o il più in basso che puoi comodamente. Fermati un attimo in fondo, poi spingi attraverso i talloni per tornare alla posizione di partenza. Ripeti per il numero desiderato di ripetizioni.",
    ...
    "zh": "双脚分开与肩同宽站立，双手握住哑铃垂直放在胸前。 保持胸部挺直，核心收紧，通过向后推臀部并弯曲膝盖，将身体降低至蹲姿。 继续降低，直到大腿与地面平行，或者尽可能低。 在底部停顿片刻，然后推动脚后跟回到起始位置。 重复所需的重复次数。"
  },
  "instruction_steps": {
    "en": [
...
},
{
  ...
  "instructions_en": {
    ...
    "es": "Ponte de pie con los pies separados a la altura de los hombros, sujetando una mancuerna en cada mano. Da un paso hacia adelante con un pie y coloca los pies de modo que el pie delantero quede plano en el suelo y el pie trasero quede elevado sobre un banco o escalón. Baja el cuerpo flexionando la rodilla y la cadera delanteras, manteniendo la rodilla trasera ligeramente flexionada y el talón trasero levantado del suelo. Continúa bajando hasta que el muslo delantero quede paralelo al suelo, luego empuja con el talón delantero para volver a la posición inicial. Repite el número de repeticiones deseado y luego cambia de pierna y repite.",
    ...
    "zh": "双脚分开与肩同宽站立，每只手各握一个哑铃。 一只脚向前迈出一步，调整双脚的位置，使前脚平放在地面上，后脚抬高在长凳或台阶上。 弯曲前膝盖和臀部，降低身体，保持后膝盖稍微弯曲，后脚跟离开地面。 继续降低，直到大腿前部与地面平行，然后通过前脚跟推回到起始位置。 重复所需的重复次数，然后换腿并重复。"
  },
  "instruction_steps": {
    "en": [
...
},
{
  ...
  "instructions_en": {
    ...
    "it": "Stai con i piedi a larghezza delle spalle, tenendo un manubrio in ogni mano con una presa sopra la testa. Tenendo la schiena dritta e il core attivo, incurvati ai fianchi e abbassa i manubri verso terra, permettendo alle ginocchia di piegarsi leggermente. Abbassa i manubri finché non senti uno stiramento ai muscoli femorale, poi spingi attraverso i talloni e attiva i glutei per tornare alla posizione iniziale. Ripeti per il numero desiderato di ripetizioni.",
    ...
    "zh": "双脚分开与肩同宽站立，双手各握一个哑铃，正握。 保持背部挺直，核心收紧，以臀部为铰链，将哑铃向地面降低，让膝盖稍微弯曲。 降低哑铃，直到感觉到腿筋拉伸，然后推动脚后跟并收紧臀肌，回到起始位置。 重复所需的重复次数。"
  },
  "instruction_steps": {
    "en": [
...
{
  "name": "哑铃臀推",
  "name_en": "glute bridge two legs on bench (male)",
  "target": "glutes",
  "secondary": [
    "hamstrings",
    "core"
  ...
  "gif": "exercise_gifs/3523-aWedzZX.gif",
  "gif_url": "videos/3523-aWedzZX.gif",
  "instructions_cn": "",
  "instructions_en": {
    "en": "Sit on the edge of a bench with your back against it and your feet flat on the ground. Place your hands on the bench beside your hips for support. Engage your glutes and hamstrings, then lift your hips off the bench until your body forms a straight line from your knees to your shoulders. Pause for a moment at the top, then slowly lower your hips back down to the starting position. Repeat for the desired number of repetitions.",
    "it": "Siediti sul bordo di una panca con la schiena appoggiata e i piedi appoggiati a terra. Metti le mani sulla panca accanto ai fianchi per supporto. Coinvolgi i glutei e i muscoli posteriori della coscia, quindi solleva i fianchi dalla panca finché il tuo corpo non forma una linea retta dalle ginocchia alle spalle. Fai una pausa per un momento in alto, quindi abbassa lentamente i fianchi fino alla posizione iniziale. Ripetere per il numero di ripetizioni desiderato.",
    "tr": "Sırtınız bankın kenarına dayalı ve ayaklarınız yere düz basacak şekilde bir bankın kenarına oturun. Destek için ellerinizi kalçalarınızın yanındaki sehpaya yerleştirin. Kalça kaslarınızı ve hamstringlerinizi çalıştırın, ardından vücudunuz dizlerinizden omuzlarınıza kadar düz bir çizgi oluşturana kadar kalçalarınızı benchten kaldırın. Tepe noktasında bir an duraklayın, ardından kalçalarınızı yavaşça başlangıç ​​pozisyonuna indirin. İstenilen sayıda tekrar için tekrarlayın.",
    "es": "Siéntate en el borde de un banco con la espalda apoyada en él y los pies planos sobre el suelo. Coloca las manos en el banco junto a las caderas para mayor apoyo. Activa los glúteos y los isquiotibiales, luego levanta las caderas del banco hasta que el cuerpo forme una línea recta desde las rodillas hasta los hombros. Haz una pausa por un momento en la parte superior, luego baja lentamente las caderas de vuelta a la posición inicial. Repite el número de repeticiones deseado.",
    ...
    "zh": "坐在长凳边缘，背靠着长凳，双脚平放在地上。 将双手放在臀部旁边的长凳上以获得支撑。 收紧臀肌和腿筋，然后将臀部抬离长凳，直到身体从膝盖到肩膀形成一条直线。 在顶部暂停片刻，然后慢慢将臀部放回起始位置。 重复所需的重复次数。"
  },
  "instruction_steps": {
    "en": [
...
},
{
  ...
  "instructions_en": {
    ...
    "zh": "平躺，双臂伸向天花板。 弯曲膝盖，将双腿抬离地面，使臀部和膝盖形成 90 度角。 接合你的核心和下背部，将你的下背部压入地面。 慢慢地将右臂和左腿放低至地面，保持它们伸直并悬停在地板上方。 暂停片刻，然后回到起始位置。 用左臂和右腿重复该动作。 继续交替进行所需的重复次数。"
  },
  "instruction_steps": {
    "en": [
...
{
  "name": "俄罗斯转体",
  "name_en": "weighted russian twist",
  "target": "abs",
  "secondary": [
    "obliques",
    "lower back"
  ...
  "instructions_en": {
    ...
    "zh": "坐在地上，膝盖弯曲，双脚平放在地板上。 双手握住重物球或健身球放在胸前。 稍微向后倾斜，保持背部挺直，核心肌群参与。 慢慢地将你的躯干向右扭转，将重物或药球拉向右侧的地板。 暂停片刻，然后将躯干向左扭转，将重物或健身球拉向左侧的地板。 继续交替进行所需的重复次数。"
  },
  "instruction_steps": {
    "en": [
...
,
{
  ...
  "equipment": "body weight",
  "gif": "exercise_gifs/5001-Wb3xQz9s.gif",
  "gif_url": "",
  "instructions_cn": "",
  "instructions_en": "",
  "instruction_steps": ""
...
,
{
  ...
  "equipment": "body weight",
  "gif": "exercise_gifs/5002-Nj5rTy2.gif",
  "gif_url": "",
  "instructions_cn": "",
  "instructions_en": "",
  "instruction_steps": ""
...
,
{
  ...
  "equipment": "body weight",
  "gif": "exercise_gifs/5003-Mk7vLp4.gif",
  "gif_url": "",
  "instructions_cn": "",
  "instructions_en": "",
  "instruction_steps": ""
